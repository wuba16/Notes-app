...
export default function Dashboard() {
  ...
  const [color, setColor]         = useState("default");   // ← ADD
  ...
  const handleUpdateNote = async () => {
    ...
    await update(ref(db, `notes/${user.uid}/${editingNote.id}`), {
      ...
      updatedAt: Date.now(),
       color,                                                    // ← add
        tags: tags.split(",").map(t => t.trim()).filter(Boolean), // ← add
    });
  ...
  const openEdit = (note: Note) => {
    ...
    setContent(note.content);
     setColor(note.color || "default");  // ← add this
     setTags(note.tags?.join(", ") || ""); // ← add this
    setShowForm(true);
  };
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="bg-violet-600 hover:bg-violet-500 text-white
                         font-semibold px-5 py-2.5 rounded-xl transition-all
          ...
          <div className="relative mb-6">
            ...
            <input
              ...
              className="w-full bg-gray-900 border border-gray-700 text-white
                         placeholder-gray-500 rounded-xl pl-11 pr-4 py-3
            ...
            <div className="bg-gray-900 border border-gray-700 rounded-2xl
              ...
              <input
                ...
                className="w-full bg-gray-800 border border-gray-700 text-white
                           placeholder-gray-500 rounded-xl px-4 py-3 mb-3
                           focus:outline-none focus:border-violet-500 transition-colors"
              />
              ...
              {/* Character counter (bonus feature) */}
...
{/* this div was already there — don't touch it */}
